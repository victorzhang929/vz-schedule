...
<script type="text/javascript" src="<%=basePath%>js/teacherInfo.js"></script>
<title>教师信息</title>
</head>
...
<div id="box">
	<div id="content-header">
		<div id="breadcrumb">
			...
			</a> <a href="javascript:void(0);" title="教师信息 " class="tip-right"> 教师信息 </a>
		</div>
	</div>
				...
				<div class="widget-box">
					<div class="widget-content nopadding">
						<div class="controls controls-row">
							...
							<input type="text" id="queryname" class="span2 m-wrap" placeholder="教师姓名">
							<a id="query" class="span1 btn btn-success" onclick="load()"><i class="icon-search"></i>查询</a>
							<a id="add" href="#modalDiv2" data-toggle='modal' class="span1 btn btn-primary" onclick="addTeacherUI()"><i class="icon-plus"></i>添加教师</a>
...
<div id="modalDiv2" class="modal hide">
	...
	<div class="modal-footer"> 
		<div id='msg2'></div>
		<a data-dismiss="modal" class="btn" href="javascript:void(0);"> <i class="icon-remove"></i>取消</a> 
		<a id="m2btnComfirm"  class="btn btn-success" href="javascript:void(0);" onclick="addTeacher()"> <i class="icon-ok"></i>确定</a> 
	</div>
</div>
</body>
</html>
